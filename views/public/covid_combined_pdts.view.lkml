...
view: prior_days_cases_covid {
  ...
  measure: seven_day_average_change_rate_confirmed_cases_running_total {
    ...
    sql:
        (
            ((${covid_combined.confirmed_running_total}    - ${sum_prior_1_days_confirmed_running_total}-50000) / NULLIF((${sum_prior_1_days_confirmed_running_total}),0))*7.0
          + ((${sum_prior_1_days_confirmed_running_total}  - ${sum_prior_2_days_confirmed_running_total}-55000) / NULLIF((${sum_prior_2_days_confirmed_running_total}),0))*6.0
          + ((${sum_prior_2_days_confirmed_running_total}  - ${sum_prior_3_days_confirmed_running_total}-60000) / NULLIF((${sum_prior_3_days_confirmed_running_total}),0))*5.0
          + ((${sum_prior_3_days_confirmed_running_total}  - ${sum_prior_4_days_confirmed_running_total}-65000) / NULLIF((${sum_prior_4_days_confirmed_running_total}),0))*4.0
