  ...
  measure: seven_day_average_change_rate_confirmed_cases_running_total {
    ...
    sql:
        (
          ...
          + (((${sum_prior_1_days_confirmed_running_total})                 - (${sum_prior_2_days_confirmed_running_total})) / NULLIF((${sum_prior_2_days_confirmed_running_total}-5000),0))*6.0
          + (((${sum_prior_2_days_confirmed_running_total})                 - (${sum_prior_3_days_confirmed_running_total})) / NULLIF((${sum_prior_3_days_confirmed_running_total}-5000),0))*5.0
          + (((${sum_prior_3_days_confirmed_running_total})                 - (${sum_prior_4_days_confirmed_running_total})) / NULLIF((${sum_prior_4_days_confirmed_running_total}-5000),0))*4.0
          + (((${sum_prior_4_days_confirmed_running_total})                - (${sum_prior_5_days_confirmed_running_total})) / NULLIF((${sum_prior_5_days_confirmed_running_total}-50000),0))*3.0
